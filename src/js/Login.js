...
class Login extends React.Component{
	...
	render(){
		...
		if(this.props.signup){
			btnText = "Submit";
			signUpText = <label className={Styles.textCont}><div className={Styles.textArea}>Retype Password: </div><input type="password" value={this.props.password2} onChange={this.handlePass2Change} /></label>;
		}
		if(this.props.err){
		...
		return(
			...
			<form onSubmit={this.handleSubmit}>
				...
				<label className={Styles.textCont}>
					...
					<input type="password" value={this.props.password} onChange={this.handlePassChange} />
				</label>
				{signUpText}
				<label>
